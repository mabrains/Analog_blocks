...
N 830 -660 900 -660 { lab=#net3}
N 630 -840 630 -770 { lab=Vin}
N 380 -720 470 -720 { lab=Vref}
N 280 -660 470 -660 { lab=#net2}
N 400 -600 470 -600 { lab=#net1}
N 400 -600 400 -460 { lab=#net1}
N 400 -460 940 -460 { lab=#net1}
N 630 -550 630 -320 { lab=GND}
...
C {/home/eslam/mabrains/Analog_blocks/Analog_Blocks/LDO/Schematic/LDO_Folded_1.8v/Error_amplifier_Folded.sym} 630 -660 0 0 {name=x1}
