...
C {/home/eslam/Analog_blocks/Analog_Blocks/LDO/Schematic/LDO_Folded_2.2v/LDO_Folded_2.2v.sym} 980 -1060 0 0 {name=x1}
C {devices/code_shown.sym} 1305 -1385 0 0 {name=NGSPICE1
only_toplevel=true
value=" 
************************************************
...
.end
" }
C {devices/code.sym} 1760 -1160 0 0 {name=TT_MODELS1
spice_ignore=false
only_toplevel=true
