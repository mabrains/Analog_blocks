...
N 1640 -1180 1980 -1180 { lab=Ibias}
...
N 2410 -1160 2410 -960 { lab=Vout}
N 2190 -770 2410 -770 { lab=Gnd}
N 2410 -770 2490 -770 { lab=Gnd}
N 2410 -960 2410 -950 { lab=Vout}
...
N 1890 -1130 2190 -1130 { lab=Ibias}
N 1890 -1180 1890 -1130 { lab=Ibias}
...
N 2320 -1190 2370 -1190 { lab=Ibias}
N 2320 -1190 2320 -1130 { lab=Ibias}
N 2190 -1130 2320 -1130 { lab=Ibias}
N 2410 -990 2500 -990 { lab=Vout}
N 1600 -1120 1660 -1120 { lab=Ibias}
N 1660 -1180 1660 -1120 { lab=Ibias}
...
C {sky130_fd_pr/cap_mim_m3_2.sym} 2340 -990 3 0 {name=C1 model=cap_mim_m3_2 W=1 L=1 MF=1 spiceprefix=X}
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1620 -1180 0 1 {name=M8
L=0.5
W=20
nf=1
mult=1
...
C {devices/opin.sym} 2500 -990 0 0 {name=p6 lab=Vout}
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 2390 -920 0 0 {name=M6
L=0.5
W=50
nf=1
mult=2
