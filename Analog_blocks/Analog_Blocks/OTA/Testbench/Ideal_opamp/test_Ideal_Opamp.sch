...
S {}
E {}
N 280 -290 380 -290 { lab=Vp}
N 310 -410 380 -410 { lab=Vout}
N 310 -510 310 -410 { lab=Vout}
N 310 -510 700 -510 { lab=Vout}
N 700 -510 700 -350 { lab=Vout}
N 700 -350 730 -350 { lab=Vout}
N 660 -350 700 -350 { lab=Vout}
C {devices/code.sym} 460 -700 0 0 {name=TT_MODELS
spice_ignore=false
only_toplevel=true
...
"}
C {devices/code_shown.sym} 835 -775 0 0 {name=NGSPICE1
only_toplevel=true
value="
**************************************
*DC Analysis 
...
.end
" }
C {devices/lab_pin.sym} 280 -290 0 0 {name=l2 sig_type=std_logic lab=Vp}
C {devices/lab_pin.sym} 730 -350 0 1 {name=l6 sig_type=std_logic lab=Vout}
C {/home/eslam/mabrains/Analog_blocks/Analog_Blocks/OTA/Schematic/Ideal_opamp/Ideal_opamp.sym} 520 -350 0 0 {name=x1}
